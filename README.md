...
## 🎯 MVP: Automated Strategy Validation (current phase)

Before building the SaaS, the MVP proves (or falsifies) the core betting
strategy with a fully automated, zero-cost pipeline in
...
them the next morning, and maintain a running paper-trade ledger.

- 📈 **Live results:** [`reports/BETTING_REPORT.md`](reports/BETTING_REPORT.md)
- 📅 **Daily reports:** [`reports/daily/`](reports/daily)
...
- 🗄️ **Historical calibration:** [`reports/CALIBRATION.md`](reports/CALIBRATION.md) (generated by the `MVP Historical Calibration` workflow)

Setup requires a single secret: `ODDS_API_KEY`
([free tier](https://the-odds-api.com), 500 credits/month). The legacy
Flask/React scaffold below is frozen until the strategy is validated.
