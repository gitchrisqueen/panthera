...
**INCONCLUSIVE — collecting data.** 6/100 graded picks recorded. Verdict criteria (pre-registered): after 100 graded picks, ROI > 0% → strategy SUPPORTED; ROI < -5% → strategy FALSIFIED; otherwise inconclusive, keep collecting.
...
|---|---|---|---|
| R3 | 1-0-0 | $+60.61 | +60.61% |
| R3_form | 2-1-0 | $+160.00 | +53.33% |
...
|---|---|---|---|
| ml | 3-1-0 | $+220.61 | +55.15% |
| rl | 0-2-0 | $-200.00 | -100.00% |
...
| 2026-08-02 | Philadelphia Phillies @ Baltimore Orioles | Baltimore Orioles ML | +118 | R3_form | pending |  |
| 2026-08-02 | Washington Nationals @ Atlanta Braves | Atlanta Braves ML | -121 | R3_form | pending |  |
| 2026-08-02 | St. Louis Cardinals @ Toronto Blue Jays | Toronto Blue Jays ML | -123 | R3_form | pending |  |
