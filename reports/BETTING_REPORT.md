...
**INCONCLUSIVE — collecting data.** 24/100 graded picks recorded. Verdict criteria (pre-registered): after 100 graded picks, ROI > 0% → strategy SUPPORTED; ROI < -5% → strategy FALSIFIED; otherwise inconclusive, keep collecting.
...
|---|---|---|---|
| R3 | 3-4-0 | $-93.39 | -13.34% |
| R3_form | 4-4-0 | $+15.10 | +1.89% |
| R3_series | 1-1-0 | $+55.00 | +27.50% |
| R4 | 0-2-0 | $-200.00 | -100.00% |
| R5 | 2-3-0 | $-30.00 | -6.00% |
