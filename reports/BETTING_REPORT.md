...
**INCONCLUSIVE — collecting data.** 76/100 graded picks recorded. Verdict criteria (pre-registered): after 100 graded picks, ROI > 0% → strategy SUPPORTED; ROI < -5% → strategy FALSIFIED; otherwise inconclusive, keep collecting.

## Headline

- **Record:** 33-43-0 (0 void)
- **P/L:** $-628.92 on $7,600 risked
- **ROI:** -8.28%
- **Pending picks:** 0
...
|---|---|---|---|
| R3 | 10-16-0 | $-455.20 | -17.51% |
| R3_form | 8-10-0 | $-220.05 | -12.22% |
| R3_series | 4-7-0 | $-213.51 | -19.41% |
| R4 | 2-3-0 | $-187.47 | -37.49% |
...
|---|---|---|---|
| ml | 22-33-0 | $-888.76 | -16.16% |
| rl | 11-10-0 | $+259.84 | +12.37% |
